...
ExceptionHandler(ExceptionType which)
{
	...
	DEBUG('a', "Shutdown, initiated by user program.\n");
       ...
       printf("[pid %d]: Exit called at totalTicks = %d. Code: %d\n", currentThread->GetPID(), stats->totalTicks, exitcode);
//***************************************************************************************************
     /*  printf("thread_waitime : %d\nthread_idle_time : %d\nthread_burst_time : %d\nSum of these : %d\n total lifetime of thread : %d\n"
        ,currentThread->wait_total_time, currentThread->idle_total_time, currentThread->burst_total_time,
         currentThread->wait_total_time+ currentThread->idle_total_time + currentThread->burst_total_time, stats->totalTicks - currentThread->thread_start_time);
    */
//***************************************************************************************************
