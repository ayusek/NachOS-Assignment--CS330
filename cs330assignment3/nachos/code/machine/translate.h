...
class TranslationEntry {
  public:
    ...
    bool shared; //by default it will be false for all.
            // will be set true only for those pagetable entries which will
            // be created by sys_ShmAllocate() function
    bool inBackUp; // to check whether the data is in backup or in the main memory
};
